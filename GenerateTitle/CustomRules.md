...
Examples:  
- Onboarding | Sarah Williams | 10/21/2025  
- Onboarding | Jacob Li | 11/04/2025  
- Onboarding | Emma Chen | 09/30/2025  
...
Examples:  
- Reactive | Unable to log into Outlook | Office 365  
- Reactive | VPN not connecting | VPN  
- Reactive | MFA code not working | Office 365  
...
Examples:  
- Provisioning | Laptop setup for new hire | Dell Latitude  
- Provisioning | Dual monitor connection issue | HP Docking Station  
- Provisioning | Keyboard not detected | USB Peripheral  
...
Examples:  
- Access | Unable to open Teams | Microsoft 365  
- Access | Missing permissions in QuickBooks | QuickBooks Online  
- Access | Adobe license activation failed | Adobe Creative Cloud  
...
Examples:  
- Configuration | Network drive mapping for Finance | Finance Department  
- Configuration | CRM access setup | Sales Department  
- Configuration | Security group assignment | IT Department  
...
Examples:  
- Onboarding (Scheduled) | Michael Torres | 11/18/2025  
- Onboarding (Scheduled) | Priya Patel | 12/02/2025  
...
Examples:  
- Contractor | Temporary laptop setup | 30-day assignment  
- Contractor | Shared account creation | Marketing Team  
